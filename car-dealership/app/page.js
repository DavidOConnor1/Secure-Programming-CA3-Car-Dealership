...
import { Car, Shield, Target, Award, Clock, Users, CheckCircle, Phone, Mail, MapPin } from 'lucide-react';
    ...
    const featuredVehicles = [
      {
        ...
        price: "$87,000",
        image: "https://www.autoblog.com/.image/w_3840,q_auto:good,c_limit/MjA5MDg4OTM3NDAxMTMyNjU2/2023-honda-civic-type-r.jpg",
        features: ["VTEC", "TURBO", "Manual Transmission", "4.9s 0-60"]
      },
      {
        name: "2025 Mazda MX-5",
        price: "$36,900",
        image: "https://hips.hearstapps.com/hmg-prod/images/2025-mazda-mx-5-miata-35th-anniversary-pr-114-6792b9db0b3ec.jpg?crop=0.707xw:0.596xh;0.168xw,0.334xh&resize=2048:*",
        features: ["Convertible", "Manual Transmission", "Discounted"]
      },
      {
        name: "2026 Toyota AE-86",
        price: "$40,000",
        image: "https://cdn.motor1.com/images/mgl/13P3q/s1/modern-day-toyota-ae86-rendering-front.webp",
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-8 bg-zinc-50 dark:bg-gray-900 rounded-xl">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-black dark:text-white">Transparent Process</h3>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <div className="text-center p-8 bg-zinc-50 dark:bg-gray-900 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  All of our vehicles are inspected and maintained to the highest degree to provide a safe and reliable drive.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-10 text-gray-300">
                Visit us today or schedule a test drive. Our car enthusiast team is ready to help you find the perfect vehicle.
              </p>
